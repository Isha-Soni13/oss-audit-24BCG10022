...
1. **script1_system_identity.sh** — Shows your Linux system information
2. **script2_package_inspector.sh** — Checks if Git is installed + philosophy
3. **script3_disk_auditor.sh** — Audits disk usage & permissions
4. **script4_log_analyzer.sh** — Searches logs for specific keywords
5. **script5_manifesto_generator.sh** — Generate your open-source philosophy
...
- **Part C:** The FOSS ecosystem (2 pages)
- **Part D:** Git vs alternatives (2-3 pages)

---

## License

This project is licensed under **GPL v2** (same as Git). That means you can use, study, modify, and share it freely.
